...
void Paint_DrawLine(uint8_t Xstart, uint8_t Ystart, uint8_t Xend, uint8_t Yend, 
                    uint8_t Color, DOT_PIXEL Line_width, LINE_STYLE Line_Style)
{
    if (Xstart > 240 || Ystart > 240 || Xend > 240 || Yend > 240) {
        return;
    }
...
******************************************************************************/
void Paint_DrawRectangle( uint8_t Xstart, uint8_t Ystart, uint8_t Xend, uint8_t Yend, 
                          uint8_t Color, DOT_PIXEL Line_width, DRAW_FILL Filled )
{
...
******************************************************************************/
void Paint_DrawChar(uint8_t Xpoint, uint8_t Ypoint, const char Acsii_Char,
...
parameter:
    ...
    Color_Foreground : Select the foreground color of the English character
******************************************************************************/
void Paint_DrawString_EN(uint8_t Xstart, uint8_t Ystart, const char * pString,
                         sFONT* Font, uint8_t Color_Background, uint8_t Color_Foreground )
{
    uint8_t Xpoint = Xstart;
    uint8_t Ypoint = Ystart;
...
void Paint_DrawNum(uint8_t Xpoint, uint8_t Ypoint, int32_t Nummber,
                   sFONT* Font, uint8_t Color_Background, uint8_t Color_Foreground )
{
